...
const DialogWrap = styled.div`
  ...
  ${props =>
    !props.width && props.position.x !== "stretch" && `min-width: 20rem;`}
  ${props =>
    !props.width && props.position.x !== "stretch" && `max-width: 30rem;`}
  ...
  theme.darkMode ? "rgba(0, 0, 0, 0.3)" : "rgba(14,30,37,0.15)"};
      ...
      >
        ...
        >
          <DialogWrap width={width} position={position} isMobile={isMobile}>
            ...
            {actions && (
              <DialogActions isMobile={isMobile}>{actions}</DialogActions>
            )}
          </DialogWrap>
        </TransitionComponent>
      </Modal>
