      ...
      <Row>
        <ButtonGroup>
          <Button
            primary
            size="sm"
            onClick={() => setDefaultSmallDialogOpen(true)}
          >
          ...
          <Button
            ...
            size="sm"
            type="danger"
            onClick={() => setDangerSmallDialogOpen(true)}
          >
        ...
        <Dialog
          ...
          actions={
            <ButtonGroup>
              <Button onClick={() => setDefaultSmallDialogOpen(false)}>
                Cancel
              </Button>
              <Button
                primary
                type="default"
                onClick={() => setDefaultSmallDialogOpen(false)}
              >
                Okie day
              </Button>
            </ButtonGroup>
        ...
        <Dialog
          ...
          actions={
            <ButtonGroup>
              <Button onClick={() => setSuccessSmallDialogOpen(false)}>
                Cancel
              </Button>
              <Button
                primary
                type="success"
                onClick={() => setSuccessSmallDialogOpen(false)}
              >
                Become a Jedi
              </Button>
            </ButtonGroup>
        ...
        <Dialog
          ...
          actions={
            <ButtonGroup>
              <Button onClick={() => setDangerSmallDialogOpen(false)}>
                Cancel
              </Button>
              <Button
                primary
                type="danger"
                onClick={() => setDangerSmallDialogOpen(false)}
              >
                How Wude!
              </Button>
            </ButtonGroup>
